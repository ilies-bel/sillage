...
// (SILLAGE_ONNX_SENTINEL_DISABLED=1) short-circuits all writes to a no-op
 ...
 *  ON; set SILLAGE_ONNX_SENTINEL_DISABLED=1 in production to opt out. */
function sentinelEnabled(): boolean {
    return process.env.SILLAGE_ONNX_SENTINEL_DISABLED !== '1';
}

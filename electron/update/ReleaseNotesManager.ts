...
export class ReleaseNotesManager {
    ...
    // No public release channel yet. Set both to point the updater at one;
    // fetchReleaseNotes() returns null while either is empty.
    private readonly repoOwner = process.env.RELEASE_REPO_OWNER ?? "";
    private readonly repoName = process.env.RELEASE_REPO_NAME ?? "";
